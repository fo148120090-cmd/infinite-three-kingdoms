...
export default function App(){
  ...
  return <main className="game-shell">
    ...
    {screen==="battle"&&<section className="page play-page battle-page"><div className="battle-header"><div><span className="eyebrow">{roomKo[battle.room]}</span><h2>{battle.room==="evilCave"?"악의 동굴 · 세계의 구멍":battle.room==="boss"?"심층 관문":battle.repeatScenarioFloor!==undefined?"시나리오 재도전":"자동 전투 진행 중"}</h2><p className="muted">전투 명령 없음 · 일시정지와 재생 속도만 조절할 수 있습니다.</p></div>
      ...
      <div className={"battle-scene battle-scene-"+battle.mode+" battle-room-"+battle.room}><div className="battle-sky-glow"/><div className="battle-banner-left">⚔ FRONTIER ARMY</div><div className="battle-banner-right">ENEMY FRONT ⚠</div><div className="battle-layout"><div className="cave-panel"><div className="cave-label"><span>입구</span><span>심층</span></div><div className="cave-lane"><div className="cave-floor"/>
