...
import { choosePromotion, grantExperience, promotionActions, promotionForecast, promotionLabel, promotionOptions, xpRequiredForLevel } from "./promotion";
