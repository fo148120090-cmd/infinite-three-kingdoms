...
export default function MonsterArt({species="Goblin",grade="Normal",size=42}:Props){
  ...
  return <svg className={"monster-art-svg monster-art-"+key.toLowerCase()+" monster-art-grade-"+String(grade).toLowerCase()} width={size} height={size} viewBox="0 0 64 64" role="img" aria-label={species+" monster"}>
    ...
    {isUruk ? <g fill={p.accent} stroke="#1b2230" strokeWidth="1.2"><path d="M17 28L9 7L24 16L32 8L40 16L55 7L47 28Z"/><path d="M20 24L24 13L32 20L40 13L44 24L39 28L25 28Z" fill={p.body}/><path d="M17 29L12 39L20 36L24 48L32 40L40 48L44 36L52 39L47 29" fill={p.accent}/><path d="M22 31L17 47M42 31L47 47M27 34L25 52M37 34L39 52" fill="none"/><path d="M21 50L32 43L43 50L38 56L26 56Z" fill={p.body}/></g> : isKobold ? <g fill="none" stroke={p.accent} strokeWidth="1.7" strokeLinecap="round"><path d="M18 24Q22 12 32 16Q42 12 46 24"/><path d="M22 26L16 18M42 26L48 18"/><path d="M26 28L32 22L38 28"/></g> : isGnoll ? <g fill={p.accent} stroke="#1b2230" strokeWidth="1.1"><path d="M16 27Q18 15 28 19L32 12L36 19Q46 15 48 27L43 31L21 31Z"/><path d="M20 22Q25 18 29 23M44 22Q39 18 35 23" fill="none"/></g> : isLizardman ? <g fill={p.accent} stroke="#1b2230" strokeWidth="1.1"><path d="M17 28L14 12L24 19L32 9L40 19L50 12L47 28Z"/><path d="M21 29L15 36L23 34M43 29L49 36L41 34" fill="none" strokeWidth="1.6"/><path d="M25 21L32 17L39 21L36 25L28 25Z" fill={p.body}/></g> : isDemon ? <g fill={p.accent} stroke="#1b2230" strokeWidth="1.4"><path d="M17 27L22 7L30 20L34 7L43 27L39 31L25 31Z"/><path d="M20 31L14 43L24 38L28 53L32 42L36 53L40 38L50 43L44 31" fill={p.body}/><path d="M22 45Q32 37 42 45L38 52L26 52Z" fill={p.accent}/><path d="M18 16L11 12M46 16L53 12" fill="none" stroke={p.eye}/></g> : key==="Orc" ? <path d="M19 26L25 13L31 22L39 13L45 26" fill={p.accent} stroke="#1b2230" strokeWidth="1.2"/> : isGoblin ? <g fill={p.body} stroke="#1b2230" strokeWidth="1.3"><path d="M17 27L8 14L24 19L32 12L40 19L56 14L47 28Z"/><path d="M18 23L11 18L25 22M46 23L53 18L39 22" fill={p.accent}/></g> : isKobold ? <g fill={p.body} stroke="#1b2230" strokeWidth="1.3"><path d="M16 27L9 9L26 18L32 13L38 18L55 9L48 27Z"/><path d="M22 22L14 14M42 22L50 14" stroke={p.accent} strokeWidth="2"/></g> : isGnoll ? <g fill={p.body} stroke="#1b2230" strokeWidth="1.3"><path d="M14 27L12 15L22 19L32 11L42 19L52 15L50 28Z"/><path d="M20 25Q32 17 44 25" fill={p.accent}/></g> : isLizardman ? <g fill={p.body} stroke="#1b2230" strokeWidth="1.2"><path d="M14 29L18 12L28 18L32 9L36 18L46 12L50 29Z"/><path d="M19 24L45 24L40 29L24 29Z" fill={p.accent}/></g> : isSlime ? <g fill={p.body} stroke="#1b2230" strokeWidth="1.4"><path d="M12 49Q10 35 16 24Q23 13 32 17Q42 13 49 25Q55 36 52 49Q43 56 32 57Q21 56 12 49Z"/><path d="M20 25Q32 18 44 25Q38 31 32 30Q26 31 20 25Z" fill={p.accent} opacity=".7"/></g> : null}
    {isArachne&&<g fill="none" stroke={p.accent} strokeWidth="1.15" opacity=".9"><path d="M15 24Q32 10 49 24M10 34Q32 20 54 34M13 45Q32 31 51 45"/><path d="M32 16V52M19 19L45 49M45 19L19 49"/><circle cx="32" cy="34" r="12"/><circle cx="32" cy="34" r="7"/><path d="M25 27L21 21M39 27L43 21M25 41L20 47M39 41L44 47"/></g>}
    {isOrc&&<g fill={p.accent} opacity=".85"><path d="M15 29L10 18L22 22L27 15L32 22L37 15L42 22L54 18L49 29Z"/></g>}
    {isNaga&&<g fill="none" stroke={p.accent} strokeWidth="1.8"><path d="M14 31Q22 21 31 28T50 20"/><path d="M12 39Q22 29 32 37T52 29"/><path d="M16 47Q26 38 36 46T50 40"/></g>}
    {isHarpy&&<g fill={p.accent} stroke="#1b2230" strokeWidth="1"><path d="M21 34L4 22L12 40L25 43Z"/><path d="M43 34L60 22L52 40L39 43Z"/><path d="M25 23L18 8L30 17Z"/><path d="M39 23L46 8L34 17Z"/></g>}
