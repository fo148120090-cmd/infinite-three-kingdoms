...
## Character portraits
- **RPG portraits** — Buch, OpenGameArt
- License: **CC0**
- Source: https://opengameart.org/content/rpg-portraits
- Direct asset used by the game: https://opengameart.org/sites/default/files/rpgportraits.png
- Usage: hero portrait layer in `SkinPortrait`, with the existing costume/theme treatment layered around it.

## Planned icon source
- **Fantasy RPG Icons** — drummyfish, OpenGameArt
- License: **CC0**
